---
title: "OHsint (TryHackMe) — OSINT Lab"
description: "how i solved ohsint (tryhackme) — a small osint lab about turning one photo into real-world context using only public breadcrumbs; process first, pii redacted."
date: "2025-08-16"
...
<details>
  <summary>hint: where the handle is</summary>
...
<details>
  <summary>answers: city + SSID (masked)</summary>
...
<details>
  <summary>answers: email + where found (masked)</summary>
...
<details>
  <summary>answer: holiday location (masked)</summary>
...
<details>
  <summary>answer: exposed password (masked)</summary>
