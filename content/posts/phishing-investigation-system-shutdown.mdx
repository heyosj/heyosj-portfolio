...
> **TL;DR (IOCs)**  
> **IP**: `130.250.191.154`  
> **Domains**: `nandak an[.]com` (message claims), `www.shoecatphone[.]com` (redirect destination)  
> **URL markers**: `/qs=op-…`, `/qs=r-…`, `/qs=ua-…` (tokenized routing paths)

![hunting-redirect-logic](/images/phish-1/email.png)

## What this case is (and what it isn’t)

This casefile documents a **safe** workflow for triaging a suspicious email without “clicking around” in a browser. The objective is to preserve the artifact, identify link infrastructure, and produce clean IOCs you can operationalize (block/hunt/detect).
...
## Recommended actions (what I’d do in a team)
